...
//
//     [HttpPost("register")]
//     [EnableRateLimiting("RegisterPolicy")]   // NEW: Apply rate limiting policy for registration
//     public IActionResult Register(UserRegisterDto dto)
//     {
//         if (!ModelState.IsValid)
...
//
//     [HttpPost("login")]
//     [EnableRateLimiting("LoginPolicy")]      // NEW: Apply rate limiting policy for login
//     public IActionResult Login(UserLoginDto dto)
//     {
//         if (!ModelState.IsValid)
//             return BadRequest(ModelState);
