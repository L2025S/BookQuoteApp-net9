...
using System.Text;
using BookApi.Data;
// using System.Threading.RateLimiting;  // COMMENTED OFF: Rate limiting not used
...
// ========== RATE LIMITING CONFIGURATION (COMMENTED OFF) ==========
// The following code is disabled to remove IP-based limits.
// This allows unlimited registration/login attempts for testing.
// -----------------------------------------------------------------
...
// app.UseRateLimiter();  // COMMENTED OFF: Rate limiter middleware disabled
